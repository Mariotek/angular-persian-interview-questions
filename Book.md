...
82. ### محدودیت هایی که روی metadata وجود داره چیا هستن؟
     ...
     2. کامپایلر فقط می تونه به نمادهایی که صادر شده ان ارجاع بده
...
89. ### چن تا مثال از ارور های مربوط به metatdata بزن؟
     ...
     1. **فرم عبارت پشتیبانی نمیشه:** برخی از ویژگی های زبان خارج از نحو بیان محدود کامپایلر که تو فراداده های انگولاری استفاده میشه می تونن این خطا رو ایجاد کنن.
...
195. ### How do you create schematics for libraries?
     ...
     2. **Generate schematics**: این شماتیک ها برای اصلاح پروژه ها، افزودن پیکربندی ها و اسکریپت ها و مصنوعات داربست در کتابخانه با استفاده از دستور "ng generate" استفاده میشن.
     ...
     3. **Update schematics:** این شماتیک ها برای به روز رسانی وابستگی های کتابخانه و تنظیم برای شکستن تغییرات در نسخه جدید کتابخانه با استفاده از دستور "ng update" استفاده میشه.
...
231. ### تایپ های مربوط به feature module ها چیا هستن؟
     ...
     5. **ویجت:** این مؤلفه ها ، دستورالعمل ها و لوله ها را در دسترس ماژول های خارجی قرار می دهد (برای مثال ، کتابخانه های شخص ثالث مانند UI مواد)

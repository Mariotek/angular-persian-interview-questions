...
|188| [چطوری برای مناطق مختلف build رو کانفیگ میکنی؟](#چطوری-برای-مناطق-مختلف-build-رو-کانفیگ-میکنی؟)|
|189| [منظور از کتابخونه انگولار چیه؟](#منظور-از-کتابخونه-انگولار-چیه؟)|
|190| [کامپایلر AOT چیه؟](#کامپایلر-AOT-چیه؟)|
|191| [چطوری یه المنت رو از توی ساختار کامپوننت انتخاب میکنی؟](#چطوری-یه-المنت-رو-از-توی-ساختار-کامپوننت-انتخاب-میکنی؟)|
|192| [TestBed چیه؟](#TestBed-چیه؟)|
|193| [protractor چیه؟](#protractor-چیه؟)|
|194| [منظور زا  collection چیه؟](#منظور-زا--collection-چیه؟)|
|195| [How do you create schematics for libraries?](#1)|
|196| [چطوری از Jquery توی انگولار استفاده میکنی؟](#چطوری-از-Jquery-توی-انگولار-استفاده-میکنی؟)|
|197| [What is the reason for No provider for HTTP exception?](#1)|
|198| [منظور از router state چیه؟](#منظور-از-router-state-چیه؟)|
|199| [چطوری میتونم از SASS توی پروژه انگولار استفاده کنم؟](#چطوری=میتونم=از=SASS=توی=پروژه=انگولار=استفاده=کنم؟)|
|200| [هدف از hidden property چیه؟](#هدف-از-hidden-property-چیه؟)|
|201| [فرق بین ngIf و hidden property چیه؟](#فرق-بین-ngIf-و-hidden-property-چیه؟)|
|202| [slice pipe چیه؟](#slice-pipe-چیه؟)|
|203| [برای دابرکتیو ngFor پراپرتی index چیه؟](#برای-دابرکتیو-ngFor-پراپرتی-index-چیه؟)|
|204| [هدف از ngFor trackBy چیه؟](#هدف-از-ngFor-trackBy-چیه؟)|
|205| [هدف از دایرکتیو ngSwitch  چیه؟](#هدف-از-دایرکتیو-ngSwitch--چیه؟)|
|206| [Is it possible to do aliasing for inputs and outputs?](#1)|
|207| [منظور از اپراتور امن safe navigation چیه؟](#منظور-از-اپراتور-امن-safe-navigation-چیه؟)|
|208| [تنظیمات خاصی برای انگولار 9 نیازه؟](#تنظیمات-خاصی-برای-انگولار-9-نیازه؟)|
|209| [تغییرات تایپ های امن TestBed API توی انگولار 9 چیا بودن؟](#تغییرات-تایپ-های-امن-TestBed-API-توی-انگولار-9-چیا-بودن؟)|
|210| [ارسال فلگ static برای ViewChild اجباریه؟](#ارسال-فلگ-static-برای-ViewChild-اجباریه؟)|
...
132.  ### Bazel tool چیه؟
     ...
     Bazel یک ابزار ساخت قدرتمنده که توسط گوگل توسعه یافته و به طور گسترده مورد استفاده قرار می گیره و می تونه وابستگی های بین بسته های مختلف و اهداف ساخت را پیگیری کنه. در Angular8 می تونین برنامه CLI خود را با Bazel بسازید.
...
133.  ### مزایای استفاده از ابزار Bazel چیه؟
     ...
     1. این امکان رو ایجاد میکنه که با همان ابزار بک اند و فرانت اند شما رو بسازید
     2. ساخت افزایشی و تست
     3. این امکان رو ایجاد میکنه که از راه دور ساخت و حافظه پنهان در یک مزرعه ساخت.
...
136. ### platform توی انگولار چیه؟
     ...
     platform زمینه ایه که یک برنامه Angular تو اون اجرا میشه. رایج ترین پلت فرم برای برنامه های Angular یک مرورگر وبه اما می تونه یک سیستم عامل برای یک دستگاه تلفن همراه یا یک وب سرور باشه. Runtime-Platform توسط بسته‌های angular/platform-*@ ارائه میشه و این بسته‌ها به برنامه‌هایی که از «@angular/core» و «@angular/common» استفاده می‌کنند اجازه می‌دهند در محیط‌های مختلف اجرا شن.
     برای مثال، Angular می تونه به عنوان چارچوب مستقل از پلت فرم در محیط های مختلف استفاده شود،
...
137. ### اگه یه ماژول رو دوبار import کنیم چه اتفاقی میوفته؟
     ...
     اگر چندین ماژول یک ماژول را وارد کنه، angular اون رو فقط یک بار ارزیابی میکنه (وقتی اولین بار با ماژول روبرو میشه). از این شرط پیروی میکنه حتی ماژول در هر سطحی در سلسله مراتب NgModules وارد شده ظاهر میشه.
...
140. ### چطوری headers رو برای کاربر HTTP میفرستی؟
     ...
     می‌توانید مستقیماً نقشه شی را برای client http ارسال کنید یا کلاس HttpHeaders را برای تهیه هدرها ایجاد کنید.

...
|153| [قوانین امنیتی که توی انگولار وجود دارن چیا هستن؟](#1)|
|154| [چرا دیگه از فریم ورک های web tracking استفاده نمیشه؟ ](#1)|
|155| [چرا دیگه از پکیج های web worker استفاده نمیشه؟](#1)|
|156| [چطوری ورژن CLI انگولار رو پیدا میکنی؟](#1)|
|157| [ورژن هایی که از انگولار پشتیبانی میکنن کدوما هستن؟](#1)|
|158| [schematic چیه؟](#1)|
|159| [قوانینی که توی Schematices چیا هستن؟](#1)|
|160| [Schematics CLI چیه؟](#1)|
|161| [بهترین حالت پیاده سازی قوانین امنیتی توی انگولار چیه؟](#1)|
|162| [توی انگولار چطوری از XSS Atack جلوگیری میکنی؟](#1)|
|163| [قانون مربوط به جلوگیری از حمله XSS توی کامپایلر انگولار چیه؟](#1)|
|164| [موضوع های امنیتی مختلف که توی انگولار  وجود دارن چیا هستن؟](#16)|
|165| [Sanitization چیه و انگولار ازش پشتیبانی میکنه؟](#1n?Is-angular-supports-it)|
|166| [هدف از innerHTML چیه؟](#1)|
|167| [تفاوت بین interpolated content و innerHTML چیه؟](#1)|
...
|175| [داشتن interceptor های چن تایی توی انگولار پشتیبانی میشه؟](#1)|
|176| [چطوری میتونم از interceptor برای کل پروژه استفاده کنم؟](#1)|
|177| [چطوری انگولار internationalization رو انجام میده؟](#1)|
|178| [چطوری به صورت دستی دیتای لوکال رو ذخیره میکنی؟](#1)|
|179| [چهار فازی که برای ترجمه انجام میشه چیا هستن؟](#1)|
|180| [هدف از اتربیوت i18n چیه ؟](#1)|
|181| [هدف از custom id چیه؟](#1)|
|182| [اگه یه custom id, unique نباشه چه اتفاقی میوفته؟](#1)|
|183| [میتونم یه متن رو بدون ساخت المنت ترجمه کنم؟](#1)|
|184| [چطوری میتونم اتربیوت ها رو ترجمه کنم؟](#1)|
|185| [دسته بندی های pluralization رو لیست کن؟](#1)|
|186| [عبارت برای انتخاب ICU چیه؟](#1)|
|187| [چطوری ترجمه های ناقص رو گزارش میکنی؟](#1)|
...
10. ### ماژول چیه؟
     ...
     3. گزینه bootstrap به Angular می گه که کدام کامپوننت رو تو برنامه بوت استرپ کنه
...
12. ### data binding چیه؟
     ...
     Data binding یک مفهوم اصلی در Angular است و امکان تعریف ارتباط بین یک مؤلفه و DOM رو فراهم می کند و تعریف برنامه های تعاملی رو بدون نگرانی در مورد فشار دادن و کشیدن داده ها بسیار آسان می کند. چهار شکل اتصال داده وجود دارد (به 3 دسته تقسیم می شه) که در نحوه جریان داده ها متفاوت است.
...
13. ### metadata چیه؟
     ...
     metadata برای تزئین یک کلاس استفاده می شود تا بتونه رفتار مورد انتظار کلاس را پیکربندی کنه. metadata توسط دکوراتورها نمایش داده می شه
     ...
     2. **Property decorators** برای ویژگی های داخل کلاس ها استفاده می شه به عنوان مثال. @import و export
     ...
     3. **Method decorators** برای متدهای داخل کلاس ها استفاده می شه به عنوان مثال. @HostListener
     ...
     4. **Parameter decorators** برای پارامترهای داخل سازنده کلاس استفاده می شه به عنوان مثال. @Inject، اختیاری
...
14. ### Angular CLI چی هست؟
     ...
     2. **ساخت Component ها, Directive ها و Service ها:** ng generate/g <feature-name>
         ...
         * ng تولید کامپوننت my-new-component: یک کامپوننت به برنامه خود اضافه کنید
         * ng generate directive my-new-directive: یک directive به برنامه خود اضافه کنید
         ...
         * تولید لوله my-new-pipe: یک pipe به برنامه خود اضافه کنید
         * ng generate service my-new-service: یک service به برنامه خود اضافه کنید
...
21. ### هدف از directive ngFor چی هستش؟
     ...
     ما از directive Angular ngFor در قالب برای نمایش هر آیتم در لیست استفاده می کنیم. به عنوان مثال، در اینجا ما روی لیست کاربران تکرار می کنیم،
...
24. ### منظور از interpolation چیه؟
     ...
     interpolation یه نحو خاصیه که Angular آن رو به ویژگی binding تبدیل می کنه. این یه جایگزین مناسب برای اتصال اموال است. با مهاربندهای دوتایی ({{}}) نشان داده می شود. متن بین پرانتزها اغلب نام یه ویژگی جزء است. Angular آن نام را با مقدار رشته خاصیت جزء مربوطه جایگزین می کنه.
...
25. ### template expressions ها چیا هستن?
     ...
     یک عبارت الگو مقداری شبیه به هر عبارت جاوا اسکریپت تولید می کنه. Angular عبارت رو اجرا می کنه و اون رو به خاصیت یک هدف الزام آور اختصاص میده. هدف ممکن است یک عنصر HTML، یک جزء یا یک دستورالعمل باشد. در ویژگی binding، یک عبارت الگو در نقل قول در سمت راست نماد = مانند [property]="expression ظاهر می شه.
     در نحو درون یابی، عبارت الگو با پرانتزهای مجعد دوتایی احاطه شده. به عنوان مثال، در درون یابی زیر، عبارت الگو {{username}} است،
...
28. ### pipe ها چیا هستن؟
    ...
    یک pipe داده ها رو به عنوان ورودی می گیرد و اون رو به خروجی دلخواه تبدیل می کنه. به عنوان مثال، اجازه بدین یک pipe رو برای تبدیل ویژگی تولد یک جزء به تاریخ دوست‌داشتنی با استفاده از pipe **date** در نظر بگیریم.
...
31. ### منظور از pipe سفارشی شده چیه؟
     ...
     جدا از pipe های داخلی، می توانید pipe سفارشی خود رو با ویژگی های کلیدی زیر بنویسید:
     ...
     2. کلاس pipe روش تبدیل رابط **PipeTransform** رو پیاده سازی می کند که یه مقدار ورودی و به دنبال آن پارامترهای اختیاری رو می پذیرد و مقدار تبدیل شده رو برمی گرداند.
...
32. ### یه مثال از pipe سفارشی شده بزن؟
     ...
     شما می توانید pipe های قابل استفاده مجدد سفارشی برای تغییر ارزش موجود ایجاد کنید. به عنوان مثال، اجازه بدین یه pipe سفارشی برای یافتن اندازه فایل بر اساس پسوند ایجاد کنیم،
     ...
     اکنون می توانید از pipe بالا در قالب عبارت زیر استفاده کنید.
...
52. ### پشتیبانی های مرورگر ها برای element های انگولار چیا هستن؟
     ...
     از آنجایی که عناصر Angular به عنوان عناصر سفارشی بسته بندی می شوند، پشتیبانی مرورگر از عناصر انگولاری مانند پشتیبانی از عناصر سفارشی است.
...
59. ### کامپوننت های داینامیک چیا هستن؟
     ...
     مؤلفه‌های پویا مؤلفه‌هایی هستند که مکان مؤلفه‌ها در برنامه در زمان ساخت تعریف نشده است، یعنی در هیچ قالب انگولار استفاده نمی‌شوند. اما کامپوننت نمونه سازی می شود و در زمان اجرا در برنامه قرار می گیرد.
...
63. ### Angular Router چیه؟
     ...
     Angular Router مکانیزمی است که در آن هنگام انجام وظایف برنامه توسط کاربران، ناوبری از یک نمای به نمای بعدی انجام می شود. مفاهیم یا مدل ناوبری برنامه مرورگر را به عاریت گرفته است.
...
80. ### مزایای استفاده از AOT چیه؟
     ...
     1. ** رندر سریعتر: ** مرورگر یک نسخه از پیش کامپایل شده برنامه را دانلود می کند. بنابراین می تونه برنامه را بلافاصله بدون کامپایل کردن برنامه رندر کند.
...
82. ### محدودیت هایی که روی metadata وجود داره چیا هستن؟
     ...
     در Angular، شما باید ابرداده را با محدودیت های کلی زیر بنویسید:
      ...
      2. کامپایلر فقط می تونه به نمادهایی که صادر شده اند ارجاع دهد
...
87. ### folding چیه؟
     ...
     کامپایلر فقط میتونه ارجاعات به نمادهای صادر شده در ابرداده را حل کند. جایی که برخی از اعضای غیرصادراتی هنگام تولید کد تا می شوند. i.e Folding فرآیندی است که در آن گردآورنده یک عبارت را در حین جمع آوری ارزیابی می کند و نتیجه را به جای عبارت اصلی در .metadata.json ثبت می کند.
     به عنوان مثال، کامپایلر نمی تونه مرجع انتخابگر را ارجاع دهد زیرا صادر نشده است
     ...
     به یاد داشته باشید که کامپایلر نمی تونه همه چیز را تا کند. به عنوان مثال، عملگر گسترش بر روی آرایه ها، اشیاء ایجاد شده با استفاده از کلمات کلیدی جدید و فراخوانی تابع.
...
89. ### چن تا مثال از ارور های مربوط به metatdata بزن؟
     ...
     1. **فرم عبارت پشتیبانی نمی شود:** برخی از ویژگی های زبان خارج از نحو بیان محدود کامپایلر که در فراداده های انگولاری استفاده می شود می توانند این خطا را ایجاد کنند.
...
92. ### چطوری آپشن های کامپایلرانگولار رو تنظیم میکنی؟
     ...
     گزینه های کامپایلر قالب انگولاری به عنوان اعضای شی **angularCompilerOptions** در فایل tsconfig.json مشخص شده اند. این گزینه ها در مجاورت گزینه های کامپایلر typescript مشخص می شوند.
...
97. ### چطوری dependency های مختلف توی انگولار تعریف میکنی؟
     ...
     1. ** بسته های انگولاری: ** هسته انگولاری و ماژول های اختیاری. نام بسته آنها @angular/ شروع می شود.
...
124. ### استانداردcase type ها برای استفاده توی انگولار چیا هستن؟
     ...
     1. **camelCase :** نمادها، ویژگی‌ها، روش‌ها، نام pipe ها، انتخاب‌کننده‌های دستورالعمل غیرمولفه، ثابت‌ها از حروف کوچک در حرف اول آیتم استفاده می‌کنند. به عنوان مثال، "selectedUser"
...
132.  ### Bazel tool چیه؟
     ...
     Bazel یک ابزار ساخت قدرتمند است که توسط گوگل توسعه یافته و به طور گسترده مورد استفاده قرار می گیرد و می تونه وابستگی های بین بسته های مختلف و اهداف ساخت را پیگیری کند. در Angular8 می توانید برنامه CLI خود را با Bazel بسازید.
...
136. ### platform توی انگولار چیه؟
     ...
     پلتفرم زمینه ای است که یک برنامه Angular در آن اجرا می شود. رایج ترین پلت فرم برای برنامه های Angular یک مرورگر وب است، اما همچنین می تونه یک سیستم عامل برای یک دستگاه تلفن همراه یا یک وب سرور باشد. Runtime-Platform توسط بسته‌های angular/platform-*@ ارائه می‌شود و این بسته‌ها به برنامه‌هایی که از «@angular/core» و «@angular/common» استفاده می‌کنند اجازه می‌دهند در محیط‌های مختلف اجرا شوند.
      به عنوان مثال، Angular می تونه به عنوان چارچوب مستقل از پلت فرم در محیط های مختلف استفاده شود، به عنوان مثال،
...
152. ### ورژن های مختلف انگولار چیا هستن و تفاوتشون چیه؟
     ...
     4. **Angular 4:**
          ...
          * HttpClient جدید
     5. **Angular 5:**
          * Angular 5 انگولاری را سریعتر می کند. زمان بارگذاری و زمان اجرا را بهبود بخشید.
...
167. ### تفاوت بین interpolated content و innerHTML چیه؟
     ...
     تفاوت اصلی بین کد درون یابی شده و کد داخلی در رفتار کد تفسیر شده است. محتوای درون‌یابی همیشه حذف می‌شود، یعنی HTML تفسیر نمی‌شود و مرورگر براکت‌های انگولار را در محتوای متن عنصر نمایش می‌دهد. در جایی که در innerHTML binding، محتوا تفسیر می شود، یعنی مرورگر کاراکترهای < و > را به عنوان HTMLEntities تبدیل می کند. به عنوان مثال، استفاده در قالب به صورت زیر خواهد بود.
...
171. ### چطوری سمت سرور از حمله XSS توی انگولار جلوگیری میکنی؟
     ...
     حفاظت XSS سمت سرور در یک برنامه انگولاری با استفاده از زبان قالبی که به طور خودکار از مقادیر برای جلوگیری از آسیب پذیری های XSS در سرور فرار می کند، پشتیبانی می شود. اما از زبان قالب برای تولید الگوهای Angular در سمت سرور استفاده نکنید که خطر زیادی برای معرفی آسیب‌پذیری‌های تزریق قالب ایجاد می‌کند.
...
189. ### منظور از کتابخونه انگولار چیه؟
     ...
     کتابخانه Angular یک پروژه Angular است که با یک برنامه تفاوت دارد چون نمی تونه به تنهایی اجرا شود. باید وارد شده و در یک برنامه استفاده شود. برای مثال، می‌توانید کتابخانه «سرویس‌کار» را به یک برنامه Angular وارد یا اضافه کنید که یک برنامه کاربردی را به یک برنامه وب پیشرو (PWA) تبدیل می‌کند.
...
194. ### منظور زا  collection چیه؟
     ...
     مجموعه مجموعه ای از شماتیک های مرتبط است که در یک بسته npm جمع آوری شده است. به عنوان مثال، مجموعه `@schematics/angular` در Angular CLI برای اعمال تبدیل به یک پروژه برنامه وب استفاده می شود. شما می توانید مجموعه شماتیک خود را برای سفارشی سازی پروژه های انگولاری ایجاد کنید.
...
199. ### چطوری میتونم از SASS توی پروژه انگولار استفاده کنم؟
     ...
     هنگامی که پروژه خود را با cli انگولاری ایجاد می کنید، می توانید از دستور "ng new" استفاده کنید. تمام اجزای شما را با فایل های sass از پیش تعریف شده تولید می کند.
...
213. ### منظور از entry component چیه؟
     ...
     مؤلفه ورودی هر مؤلفه ای است که Angular به طور ضروری بارگذاری می کند (یعنی عدم ارجاع آن در قالب) بر اساس نوع. به دلیل این رفتار، کامپایلر Angular در طول کامپایل نمی تونه آنها را پیدا کند. این مؤلفه ها به صورت پویا با «ComponentFactoryResolver» ایجاد می شوند.
...
219. ### ما توی انگولار 9 به آرایه entry component نیاز داریم؟ 
     ...
     خیر. در نسخه‌های انگولار قبلی، آرایه ورودی Components از ngModule decorator استفاده می‌شود تا به کامپایلر بگوید کدام مؤلفه‌ها ایجاد شده و به‌صورت پویا در view درج می‌شوند. در Angular9، این دیگر با Ivy مورد نیاز نیست.
...
223. ### انگولار چطوری کامپوننت ها رو تشخیص میده؟ با directive ها یا pipe ها؟
     ...
     کامپایلر Angular زمانی یک کامپوننت یا دستورالعمل را در قالب پیدا می کند که بتونه با انتخابگر آن کامپوننت یا دستورالعمل در آن الگو مطابقت داشته باشد. در حالی که اگر نام لوله در سینتکس لوله قالب HTML ظاهر شود، یک لوله پیدا می کند.

     **[فهرست](#فهرست)**

224. ### یه مثال برای  بزن؟NgModules

     کتابخانه های اصلی انگولاری و کتابخانه های شخص ثالث به عنوان ngmodules در دسترس هستند. 
      1. کتابخانه های انگولاری مانند FormsModule ، HttpclientModule و Routermodule Ngmodules هستند. 
...
227. ### تفاوت های بین ngmodule و javascript module چیا هستن؟
     ...
     در زیر تفاوت های اصلی بین Ngmodule انگولاری و ماژول JavaScript وجود دارد: 
      ...
      | کلاسهای ماژول را فقط در آرایه اعلامیه ها لیست کنید | میتونه تمام کلاسهای عضو را در یک پرونده غول پیکر تعریف کند | 
      | این فقط کلاسهای قابل اعلام را که متعلق به آن است صادر می کند یا از ماژول های دیگر وارد می کند | این می تونه هر کلاس را صادر کند | 
...
239. ### میتونیم سرویس هایی رو بر اساس ماژول به اشتراک بذاریم؟
     ...
     نه ، توصیه نمی شود با وارد کردن ماژول خدمات را به اشتراک بگذارید. یعنی ماژول ها را وارد کنید وقتی می خواهید فقط از دستورالعمل ها ، لوله ها و مؤلفه ها استفاده کنید. بهترین روش برای به دست آوردن خدمات مشترک از طریق "تزریق وابستگی انگولاری" است زیرا وارد کردن یک ماژول منجر به یک نمونه خدمات جدید خواهد شد.
...
241. ### ngcc چیه؟
     ...
     NGCC (کامپایلر سازگاری انگولاری) ابزاری است که Node_Module را با NDEDULE با NDIV NGC به قالب سازگار با پیچک ساخته می کند. اسکریپت `postinstall` از pack.json مطمئن خواهد شد که node_modules شما با رندر پیچک سازگار خواهد بود.
...
244. ### NoopZone چیه؟
    ...
    منطقه به طور پیش فرض در برنامه های انگولاری بارگیری و مورد نیاز است و به زاویه کمک می کند تا بداند چه موقع باعث تشخیص تغییر می شود. به این ترتیب ، این باعث می شود که توسعه دهندگان Sures روی توسعه برنامه و نه اصلی ترین قسمت انگولاری متمرکز شوند. همچنین می توانید از Angular بدون منطقه استفاده کنید اما تشخیص تغییر باید به تنهایی اجرا شود و «Zone Zone» باید در فرآیند bootstrap پیکربندی شود. 
...
246. حالت هایی که موقع حساسیت به تغییر میتونه ایجاد بشه چیا هستن؟etection?
     ...
     1. ** اولیه سازی مؤلفه: ** در حالی که راه اندازی کاربرد انگولاری ، انگولاری باعث می شود `ApplicationRef.tick ()` برای تماس با تشخیص تغییر و مشاهده. 
...
249. ### چه متد هایی از ngZone برای کنترل حساسیت تغییر استفاده میشه؟
     ...
     سرویس NGZONE یک روش `run () را ارائه می دهد که به شما امکان می دهد عملکردی را در داخل منطقه انگولاری اجرا کنید. این عملکرد برای اجرای API های شخص ثالث که توسط منطقه اداره نمی شوند و باعث تشخیص تغییر خودکار در زمان صحیح می شوند ، استفاده می شود.
...
252. ### چطوری injector ها رو با provider ها برای لول های مختلف کانفیگ میکنی؟
     ...
     با تعیین مقدار ابرداده می توانید انژکتورها را با ارائه دهندگان در سطوح مختلف برنامه خود پیکربندی کنید. پیکربندی می تونه در یکی از سه مکان اتفاق بیفتد ،
...
253. ### آیا استفاده از تزریق در هر کلاس خدمات اجباریه؟
     ...
     نه. اگر کلاس دارای دکوراتورهای انگولاری دیگری بر روی آن باشد یا هیچ وابستگی نداشته باشد ، دکوراتور `injectable ()` `injectable () لازم نیست. اما نکته مهم در اینجا هر کلاس است که با زاویه تزریق می شود تزئین شده است. 
      یعنی اگر دکوراتور را اضافه کنیم ، ابرداده "طراحی: پارامترها" اضافه می شود ، و تزریق وابستگی می تونه کار خود را انجام دهد. این دلیل دقیق اضافه کردن دکوراتور injectable () در یک سرویس در صورتی است که این سرویس دارای برخی وابستگی ها باشد. 
     ...
     2. AppService زیر با دکوراتور ساختگی و Httpservice میتونه بدون هیچ مشکلی در AppComponent تزریق شود. این امر به این دلیل است که اطلاعات متا با دکوراتور ساختگی تولید می شود.
     ...
     3. AppService زیر با تزئینات injectable و httpservice می تونه بدون هیچ مشکلی در AppComponent تزریق شود. این امر به این دلیل است که اطلاعات متا با تزئینات تزریقی تولید می شود.
...
264. ### کلاس هایی که با  ngModel تامین شدن چیا هستن؟
     ...
     دستورالعمل NGMODEL کنترل فرم را با کلاسهای ویژه CSS انگولاری به روز می کند تا وضعیت آن را منعکس کند. بیایید لیست کلاس ها را با فرمت جدولی پیدا کنیم ، 
...
267. ### میتونی چن تا مثال از validator های build-in بزنی ؟
     ...
     n فرم های واکنشی ، می توانید از اعتبار سنجی داخلی مانند "مورد نیاز" و "minl طول" در کنترل فرم ورودی خود استفاده کنید. به عنوان مثال ، فرم ثبت نام می تونه این اعتبار سنج ها را در قسمت ورودی نام داشته باشد

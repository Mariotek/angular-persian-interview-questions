...
|95| [non null تایپ ](#non-null-تایپ)|
...
|122| [چطوری یه builder](#چطوری-یه-builder)|
...
|211| [لیست مربوط به اپراتور های template expression چیا هستن؟](#لیست-مربوط-به-اپراتور-های-template-expression-چیا-هستن)|
|212| [فرق بین pipe و ternary operator ها چیه؟](#فرق-بین-pipe-و-ternary-operator-ها-چیه)|
|213| [منظور از entry component چیه؟](#منظور-از-entry-component-چیه)|
|214| [منظور از bootstraped component چیه؟](#منظور-از-bootstraped-component-چیه)|
|215| [چطوری به صورت دستی یه app رو bootstrap میکنی؟](#چطوری-به-صورت-دستی-یه-app-رو-bootstrap-میکنی)|
|216| [لازمه که یه کامپوننت رو بوت استرپ کنیم که به یه  entry component تبدیل بشه؟](#لازمه-که-یه-کامپوننت-رو-بوت-استرپ-کنیم-که-به-یه-entry-component-تبدیل-بشه)|
|217| [منظور از routed entry component چیه؟](#منظور-از-routed-entry-component-چیه)|
|218| [چرا استفاده از آزایه entry coponenet همیشه اجباری نیست؟ ](#چرا-استفاده-از-آزایه-entry-coponenet-همیشه-اجباری-نیست)|
|219| [ما توی انگولار 9 به آرایه entry component نیاز داریم؟ ](#ما-توی-انگولار-9-به-آرایه-entry-component-نیاز-داریم)|
|220| [همه ی کامپوننت ها موقع build گرفتن ایحاد میشن؟](#همه-ی-کامپوننت-ها-موقع-build-گرفتن-ایحاد-میشن)|
|221| [منظور از کامپایلر انگولار چیه؟](#منظور-از-کامپایلر-انگولار-چیه)|
|222| [نقش ngModule metadata توی مراحل کامپایل چیه ؟](#نقش-ngModule-metadata-توی-مراحل-کامپایل-چیه)|
|223| [انگولار چطوری کامپوننت ها رو تشخیص میده؟ با directive ها یا pipe ها؟](#انگولار-چطوری-کامپوننت-ها-رو-تشخیص-میده-با-directive-ها-یا-pipe-ها)|
|224| [یه مثال برای NgModules بزن؟](#یه-مثال-برای-NgModules-بزن)|
|225| [feature module ها چیا هستن؟](#feature-module-ها-چیا-هستن)|
|226| [ماژول های import شده داخل CLI ساخته شده توسط feature module ها چیا هستن؟](#ماژول-های-import-شده-داخل-CLI-ساخته-شده-توسط-feature-module-ها-چیا-هستن)|
|227| [تفاوت های بین ngmodule و javascript module چیا هستن؟](#تفاوت-های-بین-ngmodule-و-javascript-module-چیا-هستن)|
|228| [ارور هایی که میتونه با declaration ایجاد بشه چیا هستن؟](#ارور-هایی-که-میتونه-با-declaration-ایجاد-بشه-چیا-هستن)|
|229| [مراحلی که باید طی بشه  برای اینکه declaration element استفاده کنیم چیا هستن؟](#مراحلی-که-باید-طی-بشه-برای-اینکه-declaration-element-استفاده-کنیم-چیا-هستن)|
|230| [چه اتفاقی میوفته اگه ما از browserModule داخل feature module استفاده کنیم؟](#چه-اتفاقی-میوفته-اگه-ما-از-browserModule-داخل-feature-module-استفاده-کنیم)|
|231| [تایپ های مربوط به feature module ها چیا هستن؟](#تایپ-های-مربوط-به-feature-module-ها-چیا-هستن)|
|232| [منظور از provider چیه؟](#منظور-از-provider-چیه)|
|233| [نیازمندی های مروبط به provider scope چیا هستن؟](#نیازمندی-های-مروبط-به-provider-scope-چیا-هستن)|
|234| [چطوری یه ماژول رو برای provider scope اجباری میکنی؟](#چطوری-یه-ماژول-رو-برای-provider-scope-اجباری-میکنی)|
|235| [چطوری یه سرویس singleton رو ایجاد میکنی؟](#چطوری-یه-سرویس-singleton-رو-ایجاد-میکنی)|
|236| [روش های مختلف حذف سرویس های تکراری register شده چیه؟](#روش-های-مختلف-حذف-سرویس-های-تکراری-register-شده-چیه)|
|237| [چطوری متد forRoot برای جلوگیری از duplicate شدن router instance مناسبه؟](#چطوری-متد-forRoot-برای-جلوگیری-از-duplicate-شدن-router-instance-مناسبه)|
|238| [منظور از shared module چیه؟](#منظور-از-shared-module-چیه)|
|239| [میتونیم سرویس هایی رو بر اساس ماژول به اشتراک بذاریم؟](#میتونیم-سرویس-هایی-رو-بر-اساس-ماژول-به-اشتراک-بذاریم)|
|240| [چطوری direction فعلی رو برای locales بدست میاری؟](#چطوری-direction-فعلی-رو-برای-locales-بدست-میاری)|
|241| [ngcc چیه؟](#ngcc-چیه)|
|242| [کدوم class ها نباید به declaration ها اضافه بشن؟](#کدوم-class-ها-نباید-به-declaration-ها-اضافه-بشن)|
|243| [ngzone چیه؟](#ngzone-چیه)|
|244| [NoopZone چیه؟](#NoopZone-چیه)|
|245| [چطوری کامپوننت های displayBlock ایجاد میکنی؟](#چطوری-کامپوننت-های-displayBlock-ایجاد-میکنی)|
|246| [حالت هایی که موقع حساسیت به تغییر میتونه ایجاد بشه چیا هستن؟](#حالت-هایی-که-موقع-حساسیت-به-تغییر-میتونه-ایجاد-بشه-چیا-هستن)|
|247| [منظور از zone context چیه؟](#منظور-از-zone-context-چیه)|
|248| [هوک های lifecycle مروبوط به یک zone چیا هستن؟](#هوک-های-lifecycle-مروبوط-به-یک-zone-چیا-هستن)|
|249| [چه متد هایی از ngZone برای کنترل حساسیت تغییر استفاده میشه؟](#چه-متد-هایی-از-ngZone-برای-کنترل-حساسیت-تغییر-استفاده-میشه)|
|250| [جطوری تنظیمات مربوط به zonejs رو تغییر میدی؟](#جطوری-تنظیمات-مربوط-به-zonejs-رو-تغییر-میدی)|
|251| [چطوری یه انیمیشن رو trigger میکنی؟](#چطوری-یه-انیمیشن-رو-trigger-میکنی)|
|252| [چطوری injector ها رو با provider ها برای لول های مختلف کانفیگ میکنی؟](#چطوری-injector-ها-رو-با-provider-ها-برای-لول-های-مختلف-کانفیگ-میکنی)|
|253| [آیا استفاده از تزریق در هر کلاس service اجباریه؟](#آیا-استفاده-از-تزریق-در-هر-کلاس-service-اجباریه)|
|254| [منظور از optional dependency چیه؟](#منظور-از-optional-dependency-چیه)|
|255| [تایپ های مربوط به injector هرمی چیا هستن؟](#تایپ-های-مربوط-به-injector-هرمی-چیا-هستن)|
|256| [reactive form ها چیا هستن؟](#reactive-form-ها-چیا-هستن)|
|257| [dynamic form ها چیا هستن؟](#dynamic-form-ها-چیا-هستن)|
|258| [template driven form ها چیا هستن؟](#template-driven-form-ها-چیا-هستن)|
|259| [فرق بین فرم های ری اکتیو و template driven form ها چیا هستن؟](#فرق-بین-فرم-های-ری-اکتیو-و-template-driven-form-ها-چیا-هستن)|
|260| [روش هایی که برای group کردن فرم کنترل ها وجود داره چیا هستن؟](#روش-هایی-که-برای-group-کردن-فرم-کنترل-ها-وجود-داره-چیا-هستن)|
|261| [چطوری پراپرتی های یه فرم مدل رو اپدیت میکنی؟>](#چطوری-پراپرتی-های-یه-فرم-مدل-رو-اپدیت-میکنی)|
|262| [هدف از FormBuilder چیه؟](#هدف-از-FormBuilder-چیه)|
|263| [چطوری مدل تغییرات توی فرم رو اعتبار سنجی میکنی؟](#چطوری-مدل-تغییرات-توی-فرم-رو-اعتبار-سنجی-میکنی)|
|264| [کلاس هایی که با  ngModel تامین شدن چیا هستن؟](#کلاس-هایی-که-با-ngModel-تامین-شدن-چیا-هستن)|
|265| [چطوری یه فرم رو ریست میکنی؟](#چطوری-یه-فرم-رو-ریست-میکنی)|
|266| [تایپ های مربوط به validator فانکشن چیا هستن؟](#تایپ-های-مربوط-به-validator-فانکشن-چیا-هستن)|
|267| [میتونی چن تا مثال از validator های build-in بزنی ؟](#میتونی-چن-تا-مثال-از-validator-های-build-in-بزنی)|
|268| [چطوری پرفورمنس validator های async رو بیتشر میکنی؟](#چطوری-پرفورمنس-validator-های-async-رو-بیتشر-میکنی)|
|269| [چطوری ngfor  و ngIf برای یه المان همزمان تنظیم کنیم؟](#چطوری-ngfor-و-ngIf-برای-یه-المان-همزمان-تنظیم-کنیم)|
|270| [منظور از پراپرتی host توی css چیه؟](#منظور-از-پراپرتی-host-توی-css-چیه)|
|271| [چطوری route فعلی رو بدست میاری؟](#چطوری-route-فعلی-رو-بدست-میاری)|
|272| [مهار تست های کامپوننت چیه؟](#مهار-تست-های-کامپوننت-چیه)|
|273| [مزایای inlining اتوماتیک چیه؟](#مزایای-inlining-اتوماتیک-چیه)|
|274| [content projection چیه؟](#content-projection-چیه)|
|275| [ng-content به چی میگن و هدف از اون چیه؟](#ng-content-به-چی-میگن-و-هدف-از-اون-چیه)|
